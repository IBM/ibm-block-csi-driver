	...
	testCases := []struct {
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockOsDeviceConHelper.EXPECT().IdentityAwarePreScan(gomock.Any(), stagingPathWithHostPrefix, volId).Return("", false, false, false, nil)
				...
				mockOsDeviceCon.EXPECT().EnsureLogin(gomock.Any(), ipsByArrayInitiator)
				mockOsDeviceConHelper.EXPECT().RemoveGhostDevice(gomock.Any(), gomock.Any(), lun, gomock.Any()).Return(nil)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().GetArrayInitiators(ipsByArrayInitiator).Return(arrayInitiators)
				mockOsDeviceCon.EXPECT().EnsureLogin(gomock.Any(), ipsByArrayInitiator)
				mockOsDeviceConHelper.EXPECT().RemoveGhostDevice(gomock.Any(), gomock.Any(), lun, arrayInitiators).Return(nil).Times(2)
				mockOsDeviceCon.EXPECT().RescanDevices(lun, arrayInitiators).Return(nil)
				mockNodeUtils.EXPECT().GetVolumeUuid(volId).Return(volId)
				mockOsDeviceCon.EXPECT().GetMpathDevice(gomock.Any(), volId).Return("", dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockOsDeviceCon.EXPECT().RescanDevices(lun, arrayInitiators).Return(nil)
				mockNodeUtils.EXPECT().GetVolumeUuid(volId).Return(volId)
				mockOsDeviceCon.EXPECT().GetMpathDevice(gomock.Any(), volId).Return(mpathDevice, nil)
				mockNodeUtils.EXPECT().GetSysDevicesFromMpath(context.TODO(), dmSysFsName).Return(sysDevices, nil)
				mockOsDeviceCon.EXPECT().ValidateLun(gomock.Any(), mpathDevice, lun, sysDevices, gomock.Any()).Return(nil)
	...
	testCases := []struct {
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().IsNotMountPoint(stagingPathWithHostPrefix).Return(true, nil)
				mockNodeUtils.EXPECT().GetVolumeUuid(volId).Return(volId)
				mockOsDeviceConHelper.EXPECT().GetExistingMpathDevice(gomock.Any(), volId, stagingPathWithHostPrefix).Return("", dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().GetPodPath(stagingPath).Return(stagingPathWithHostPrefix)
				mockNodeUtils.EXPECT().GetVolumeUuid(volId).Return(volId)
				mockOsDeviceConHelper.EXPECT().GetExistingMpathDevice(gomock.Any(), volId, stagingPathWithHostPrefix).Return(dmSysFsName, nil)
				mockNodeUtils.EXPECT().DevicesAreNvme(gomock.Any(), dmSysFsName).Return(driver.NotNVMe, nil)
				mockOsDeviceConHelper.EXPECT().TeardownVolume(gomock.Any(), stagingPath, true, true, volId).Return(dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().IsNotMountPoint(stagingPathWithHostPrefix).Return(true, nil)
				mockNodeUtils.EXPECT().GetVolumeUuid(volId).Return(volId)
				mockOsDeviceConHelper.EXPECT().GetExistingMpathDevice(gomock.Any(), volId, stagingPathWithHostPrefix).Return("", nil)
				mockNodeUtils.EXPECT().GetVolumeUuid(volId).Return(volId)
				mockOsDeviceConHelper.EXPECT().GetMpathDevice(gomock.Any(), volId).Return("", dmNotFoundError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockOsDeviceConHelper.EXPECT().GetExistingMpathDevice(gomock.Any(), volId, stagingPathWithHostPrefix).Return(dmSysFsName, nil)
				mockNodeUtils.EXPECT().DevicesAreNvme(gomock.Any(), dmSysFsName).Return(driver.NotNVMe, nil)
				mockOsDeviceConHelper.EXPECT().TeardownVolume(gomock.Any(), stagingPath, true, true, volId).Return(nil)
	...
	testCases := []struct {
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockOsDeviceConHelper.EXPECT().GetMpathDevice(gomock.Any(), volumeId).Return(mpathDevice, nil)
	...
	testCases := []struct {
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().IsBlock(gomock.Any(), volumePathWithHostPrefix).Return(true, nil)
				mockNodeUtils.EXPECT().GetBlockVolumeStats(gomock.Any(), volumeId).Return(driver.VolumeStatistics{},
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().GetPodPath(volumePath).Return(volumePathWithHostPrefix)
				mockNodeUtils.EXPECT().IsPathExists(volumePathWithHostPrefix).Return(true)
				mockNodeUtils.EXPECT().IsBlock(gomock.Any(), volumePathWithHostPrefix).Return(false, nil)
				mockNodeUtils.EXPECT().GetVolumeUuid(volumeId).Return(volumeUuid)
				mockOsDeviceConHelper.EXPECT().IsVolumePathMatchesVolumeId(gomock.Any(), volumeUuid, volumePathWithHostPrefix).Return(true, nil)
				mockNodeUtils.EXPECT().GetFileSystemVolumeStats(gomock.Any(), volumePathWithHostPrefix).Return(driver.VolumeStatistics{}, errors.New("fail to get stats"))
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().GetVolumeUuid(volumeId).Return(volumeUuid)
				mockOsDeviceConHelper.EXPECT().IsVolumePathMatchesVolumeId(gomock.Any(), volumeUuid, volumePathWithHostPrefix).Return(true, nil)
				mockNodeUtils.EXPECT().GetFileSystemVolumeStats(gomock.Any(), volumePathWithHostPrefix).Return(volumeStats, nil)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().IsPathExists(volumePathWithHostPrefix).Return(true)
				mockNodeUtils.EXPECT().IsBlock(gomock.Any(), volumePathWithHostPrefix).Return(true, nil)
				mockNodeUtils.EXPECT().GetBlockVolumeStats(gomock.Any(), volumeId).Return(volumeStats, nil)
...
func TestNodeExpandVolume(t *testing.T) {
	...
	volumePath := "/test/path"
	volumePathWithHostPrefix := "/host/test/path"
	stagingTargetPath := "/staging/test/path"
	...
	testCases := []struct {
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().GetVolumeUuid(volId).Return(volId)
				mockNodeUtils.EXPECT().GetPodPath(volumePath).Return(volumePathWithHostPrefix)
				mockOsDeviceConHelper.EXPECT().GetExistingMpathDevice(gomock.Any(), volId, volumePathWithHostPrefix).Return("", dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().GetVolumeUuid(volId).Return(volId)
				mockNodeUtils.EXPECT().GetPodPath(volumePath).Return(volumePathWithHostPrefix)
				mockOsDeviceConHelper.EXPECT().GetExistingMpathDevice(gomock.Any(), volId, volumePathWithHostPrefix).Return(mpathDevice, nil)
				mockNodeUtils.EXPECT().DevicesAreNvme(gomock.Any(), dmSysFsName).Return(driver.NotNVMe, nil)
				mockNodeUtils.EXPECT().GetSysDevicesFromMpath(context.TODO(), dmSysFsName).Return(nil, dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().DevicesAreNvme(gomock.Any(), dmSysFsName).Return(driver.NotNVMe, nil)
				mockNodeUtils.EXPECT().GetSysDevicesFromMpath(context.TODO(), dmSysFsName).Return(sysDevices, nil)
				mockNodeUtils.EXPECT().RescanPhysicalDevices(gomock.Any(), sysDevices).Return(dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().DevicesAreNvme(gomock.Any(), dmSysFsName).Return(driver.NotNVMe, nil)
				mockNodeUtils.EXPECT().GetSysDevicesFromMpath(context.TODO(), dmSysFsName).Return(sysDevices, nil)
				mockNodeUtils.EXPECT().RescanPhysicalDevices(gomock.Any(), sysDevices).Return(nil)
				mockNodeUtils.EXPECT().ExpandMpathDevice(gomock.Any(), dmSysFsName).Return(dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().GetSysDevicesFromMpath(context.TODO(), dmSysFsName).Return(sysDevices, nil)
				mockNodeUtils.EXPECT().RescanPhysicalDevices(gomock.Any(), sysDevices).Return(nil)
				mockNodeUtils.EXPECT().ExpandMpathDevice(gomock.Any(), dmSysFsName).Return(nil)
				mockMounter.EXPECT().GetDiskFormat(mpathDevice).Return("", dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().ExpandMpathDevice(gomock.Any(), dmSysFsName).Return(nil)
				mockMounter.EXPECT().GetDiskFormat(mpathDevice).Return(fsType, nil)
				mockNodeUtils.EXPECT().ExpandFilesystem(gomock.Any(), mpathDevice, stagingTargetPath, fsType).Return(dummyError)
		...
		},
		{
			...
			testFunc: func(t *testing.T) {
				...
				mockNodeUtils.EXPECT().GetPodPath(volumePath).Return(volumePathWithHostPrefix)
				mockOsDeviceConHelper.EXPECT().GetExistingMpathDevice(gomock.Any(), volId, volumePathWithHostPrefix).Return(mpathDevice, nil)
				mockNodeUtils.EXPECT().DevicesAreNvme(gomock.Any(), dmSysFsName).Return(driver.NVMeNonNative, nil)
				mockNodeUtils.EXPECT().ExpandMpathDevice(gomock.Any(), dmSysFsName).Return(nil)
				mockMounter.EXPECT().GetDiskFormat(mpathDevice).Return(fsType, nil)
				mockNodeUtils.EXPECT().ExpandFilesystem(gomock.Any(), mpathDevice, stagingTargetPath, fsType).Return(nil)
