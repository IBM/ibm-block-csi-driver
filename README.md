...
To manually upgrade the CSI (Container Storage Interface) driver from a previous version with GitHub, perform [step 1](#installing-the-driver) of the installation procedure for the latest version.
