...
|---------|--------|-----------|
|**CSI-5231**|Service|Volume group information does not recognize operations of adding or removing PVCs if they were triggered by changing the volume group selector information.<br>**Workaround:** Change the selector information from within the PVC file.|
