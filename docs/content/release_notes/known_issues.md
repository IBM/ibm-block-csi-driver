...
|---------|--------|-----------|
|**CSI-5221**|Service|Changing the selector within VolumeGroup YAML does not update the volume group information, such as removing and adding PVCs from the volume group.<br>**Workaround:** Change the selector information from within the PVC file.|
