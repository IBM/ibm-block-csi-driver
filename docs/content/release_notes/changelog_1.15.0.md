...
IBM® Block Storage CSI driver 1.15.0 added new support and enhancements.
...
IBM® block storage CSI driver version 1.15.0 resolved the following issues:
