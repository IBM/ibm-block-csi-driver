...
- Volume expansion with policy-based replication

**General availability date:** September 2026
...
For configuration persistency over upgrade, a config map procedure was added:
