...
Version 1.8.0 increases the `SpaceEfficiency` deduplication parameter options for IBM Spectrum Virtualize family storage systems. For more information, see <scope="peer"[Creating a StorageClass](../configuration/creating_volumestorageclass.md)./>
