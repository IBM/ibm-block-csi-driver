...
2. Configure your storage system host attachment, per worker node.
    ...
    **Note:** IBM® block storage CSI driver 1.10 introduces dynamic host definition. For more information and installation instructions, see [Installing the host definer](install_hostdefinition.md). If this custom resource is not installed, the CSI driver does not dynamically define hosts on your storage system and they must be defined manually.
