...
* ```quay.io/ibmcsiblock/ibm-block-csi-host-definer-amd64:1.15.0```
* ```quay.io/ibmcsiblock/ibm-block-csi-operator-amd64:1.15.0 ```
* ```quay.io/ibmcsiblock/ibm-block-csi-driver-controller-amd64:1.15.0```
* ```quay.io/ibmcsiblock/ibm-block-csi-driver-node-amd64:1.15.0```
...
```
 curl https://raw.githubusercontent.com/IBM/ibm-block-csi-operator/v1.15.0/config/samples/csi_v1_hostdefiner_cr.yaml > csi_v1_hostdefiner_cr.yaml
 ```
