...
* ```quay.io/ibmcsiblock/ibm-block-csi-driver-node-amd64:1.14.0```
...
```
 curl https://raw.githubusercontent.com/IBM/ibm-block-csi-operator/v1.14.0/config/samples/csi_v1_hostdefiner_cr.yaml > csi_v1_hostdefiner_cr.yaml
 ```
