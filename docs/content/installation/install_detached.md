...
* ```quay.io/ibmcsiblock/ibm-block-csi-host-definer-amd64:1.12.x```
* ```quay.io/ibmcsiblock/ibm-block-csi-operator-amd64:1.12.x ```
* ```quay.io/ibmcsiblock/ibm-block-csi-driver-controller-amd64:1.12.x```
* ```quay.io/ibmcsiblock/ibm-block-csi-driver-node-amd64:1.12.x```
