...
CSI Topology can be used with SVC partitions, the additional parameters partition_name, partition_default_vg as described in [Creating a Secret](creating_secret.md) can be specified for topology secrets as well.
