...
For an example HostDefiner yaml file, see [HostDefiner](https://raw.githubusercontent.com/IBM/ibm-block-csi-operator/v1.10.0/config/samples/csi_v1_hostdefiner_cr.yaml).