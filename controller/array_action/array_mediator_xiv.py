...
class XIVArrayMediator(ArrayMediatorAbstract):
    ...
    def _generate_snapshot_response(self, cli_snapshot):
        logger.debug("+++ {} name  {} capacity {}".format(cli_snapshot, cli_snapshot.name, cli_snapshot.capacity))
    ...
    def create_volume(self, name, size_in_bytes, capabilities, pool, volume_prefix=""):
        ...
        try:
            ...
            logger.exception(ex)
            raise array_errors.PermissionDeniedError("create vol : {0}".format(name))
    ...
    def delete_volume(self, volume_id):
        ...
        try:
            ...
            logger.exception(ex)
            raise array_errors.PermissionDeniedError("delete vol : {0}".format(vol_name))
