...
from controller.array_action.array_connection_manager import ArrayConnectionManager, NoConnectionAvailableException, xiv_type
...
class TestWithFunctionality(unittest.TestCase):
    ...
    def test_with_throws_error_in_case_of_max_retires_reached(self, get_connection, sleep):
        ...
        get_connection.side_effect = [NoConnectionAvailableException(self.fqdn)]
        with self.assertRaises(NoConnectionAvailableException) as ex:
            with self.array_connection as array_mediator:
                pass
