...
VOLUME_SOURCE_SNAPSHOT = OBJECT_TYPE_NAME_SNAPSHOT = "snapshot"
VOLUME_SOURCE_VOLUME = OBJECT_TYPE_NAME_VOLUME = "volume"
VOLUME_SOURCE_ID_FIELDS = {VOLUME_SOURCE_SNAPSHOT: 'snapshot_id', VOLUME_SOURCE_VOLUME: 'volume_id'}
