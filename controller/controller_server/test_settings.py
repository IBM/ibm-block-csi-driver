...
VOLUME_NAME = "volume"
VOLUME_FINAL_NAME = "{}_{}_{}".format(DEFAULT_VOLUME_PREFIX, MINOR_VERSION_AS_CHAR, VOLUME_NAME)
VOLUME_WWN = "volume_wwn"
OBJECT_INTERNAL_ID = "object_internal_id"
OTHER_OBJECT_INTERNAL_ID = "other_object_internal_id"
SNAPSHOT_NAME = "snapshot"
SNAPSHOT_FINAL_NAME = "{}_{}_{}".format(DEFAULT_VOLUME_PREFIX, MINOR_VERSION_AS_CHAR, SNAPSHOT_NAME)
