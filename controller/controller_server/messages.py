...
secret_missing_connectivity_info_message = "secret is missing connection info"
secrets_missing_topologies_message = "secret is missing topologies"
invalid_system_id_message = "got an invalid system id: {}, validation regex: {}"
invalid_json_parameter_message = "got an invalid json parameter: {}."
...
id_should_not_be_empty_message = 'id should not be empty'
...
empty_pool_passed_message = 'pool parameter must provide value for it'
