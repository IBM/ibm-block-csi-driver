...
size_bigger_than_0_message = 'size should be bigger than 0'
...
volume_src_snapshot_id_is_missing = 'volume source snapshot id is missing'
...
volume_context_not_match_volume_message = 'volume context does not match existing volume'
