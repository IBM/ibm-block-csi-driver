...
from controllers.tests.array_action.ds8k.test_settings import VOLUME_FAKE_NAME, VOLUME_SE_ATTR_KEY, \
    ...
    GET_HOSTS_MAPPINGS_BRIEFS_ATTR_KEY, GET_HOSTS_NAME_ATTR_KEY, FLASHCOPY_ID_DELIMITER, \
    GET_HOST_MAPPINGS_ID_ATTR_KEY, GET_HOST_MAPPINGS_VOLUME_ATTR_KEY, GET_HOST_LOGIN_PORTS_ATTR_KEY, \
    LOGIN_PORT_STATE_OFFLINE, GET_HOSTS_WWPN_ATTR_KEY, \
