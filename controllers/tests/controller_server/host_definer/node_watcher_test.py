...
class NodeWatcherBase(BaseSetUp):
    def setUp(self):
        ...
        self.mock_nodes_on_node_watcher = test_utils.patch_nodes_global_variable(settings.NODES_WATCHER_PATH)
        self.mock_nodes_on_node_watcher.pop(settings.FAKE_NODE_NAME)
...
class TestWatchNodesResources(NodeWatcherBase):
    ...
    def test_do_not_create_host_definitions_on_modified_node_without_csi_node(self):
        self._default_modified_event_mocks()
        self.mock_nodes_on_node_watcher[settings.FAKE_NODE_NAME] = settings.FAKE_NODE_ID
        self.node_watcher.watch_nodes_resources()
    ...
    def _default_modified_event_mocks(self):
        ...
        self.unmanaged_csi_nodes_with_driver.add(settings.FAKE_NODE_NAME)
