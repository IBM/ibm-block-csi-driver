...
class TestKubernetesApi(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_resource_version = patch.object(utils, 'get_k8s_object_resource_version').start()
    ...
    def test_get_storage_class_stream_success(self):
        self._test_basic_resource_stream_success(
            self.k8s_api.get_storage_class_stream, self.k8s_api.storage_api.list_storage_class)

    def test_get_node_stream_success(self):
        self._test_basic_resource_stream_success(self.k8s_api.get_node_stream, self.k8s_api.core_api.list_node)

    def test_get_secret_stream_success(self):
    ...
    def _test_basic_resource_stream_success(self, function_to_test, k8s_function):
        self.mock_resource_version.return_value = test_settings.FAKE_RESOURCE_VERSION
    ...
    def test_get_csi_node_stream_success(self):
        expected_output = iter([])
        self.mock_resource_version.return_value = test_settings.FAKE_RESOURCE_VERSION
