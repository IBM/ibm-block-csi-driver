...
from controllers.array_action.registration_maps import SVC_REGISTRATION_MAP
...
class SVCArrayMediator(ArrayMediatorAbstract, VolumeGroupInterface):
    ...
    @register_csi_plugin(registration_map=SVC_REGISTRATION_MAP)
    ...
    def register_plugin(self, unique_key,  metadata):
        if self._is_plugin_needs_to_be_registered(unique_key):
