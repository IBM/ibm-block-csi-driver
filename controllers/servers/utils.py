...
def _get_array_connection_info_from_system_info(secrets, system_id):
    ...
    partition_name = None
    if servers_settings.server_settings.SECRET_PARTITION_PARAMETER in secrets:
        partition_name = secrets[server_settings.SECRET_PARTITION_PARAMETER]
    ...
    return ArrayConnectionInfo(array_addresses=array_addresses, user=user, password=password, system_id=system_id, partition_name=partition_name)
