...
FAILED_TO_GET_HOST_DEFINITION = 'Failed to get host definition {}, go this error: {}'
...
VERIFY_HOST_DEFINITION_USING_EXPONANTIAL_BACKOFF = 'Verifying host definition {}, using exponantial backoff'
...
VERIFY_HOSTS_ON_NEW_STORAGE = 'Verifying hosts on new storage {}'
NEW_STORAGE_CLASS = 'New storageClass {}'
HOST_ALREADY_ON_STORAGE_HOST_DEFINITION_READY = 'Host {} is already on storage, detected host definition {} in Ready phase'
CREATING_NEW_HOST_DEFINITION = 'Creating host Definition: {}'
VERIFY_HOST_IS_UNDEFINED = 'Verifying that host {} is undefined on storage {}'
