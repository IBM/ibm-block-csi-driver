...
class HostDefinerServicer:
        ...
        try:
            ...
            with get_agent(array_connection_info, array_type).get_mediator() as array_mediator:
                ...
                return self._generate_response(
                    array_mediator, host_name, connectivity_type_from_user, array_addresses[0], array_connection_info.partition_name)
    ...
    def _create_host(self, host, array_mediator, request):
        ...
        array_mediator.create_host(host, initiators, connectivity_type, request.io_group, request.array_connection_info.partition_name)
